...
import { useGetStudentByIdQuery } from '../../features/api/studentSlice';
import { useGetBookByIdQuery } from '../../features/api/bookSlice';
        ...
        <div className="py-8 px-10 h-screen">
            <table className="table-auto w-full">
                ...
                <tbody className="bg-gray-200 ">
                    {loans.map(loan => (
                        <tr key={loan.id}>
                            <td className="border-y-2 px-4 py-2">{loan.date}</td>
                            <td className="border-y-2 px-4 py-2">{useGetStudentByIdQuery(loan.student_id).data.name}</td>
                            <td className="border-y-2 px-4 py-2">{useGetBookByIdQuery(loan.book_id).data.name}</td>
